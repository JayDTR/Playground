...
public class EspecificarColaboradorController {
     ...
     * plataforma com uma cópia da mesma, e copia a organizações correspondente
     * ao e-mail utilizado no login da API.
     */
    public EspecificarColaboradorController() throws SQLException {
    ...
    public boolean novoColaborador(String nome, String telefone, String email) throws Exception {
        try {
            ...
            return this.org.getRepositorioColaborador().registaColaborador(Constantes.ROLE_COLABORADOR_ORGANIZACAO, c);
        } catch (Exception ex) {
     ...
     */
    public List<Colaborador> getListColaboradores() throws SQLException {
        return plat.getRc().getColaboradoresByOrg(this.org);
    }
}
