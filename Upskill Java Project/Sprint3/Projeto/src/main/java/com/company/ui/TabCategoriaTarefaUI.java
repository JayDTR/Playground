...
public class TabCategoriaTarefaUI implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(TabCategoriaTarefaUI.class.getName()).log(Level.SEVERE, null, ex);
        }
        
    }

    @FXML
    private void actionAdicionarNovaCatTarefa(ActionEvent event) throws SQLException {
        try {
