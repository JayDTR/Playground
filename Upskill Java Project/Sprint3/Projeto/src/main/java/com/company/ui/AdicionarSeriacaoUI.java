...
public class AdicionarSeriacaoUI implements Initializable {
    ...
    void associarParentUI(TabAnunciosUI tabAnunciosUI) throws SQLException {
    ...
    @FXML
    private void actionAddColabParticipantes(ActionEvent event) throws IOException, SQLException {
    ...
    void updateListSeriacao() throws SQLException {
        tabAnunciosUI.updateSeriacaoList();
    }
