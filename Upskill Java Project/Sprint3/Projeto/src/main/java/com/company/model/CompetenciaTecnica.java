...
public class CompetenciaTecnica {
     ...
     * Declaração do objeto área de atividade.
     */
    private RegistoGrausProficiencia grausProficiencia;
    ...
    public CompetenciaTecnica(String id, String descBreve, String descDetalhada, AreaAtividade areaAtividade) {
        ...
        this.grausProficiencia = new RegistoGrausProficiencia();
    }
     ...
     * @return objecto área de atividade da competência técnica
     */
    public List<GrauProficiencia> getListaGrausProficiencia() throws SQLException {
        return this.grausProficiencia.getListaByCompTec(id);
    }
    
    public ArrayList<String> getListaGrausProficienciaString() throws SQLException {
        ArrayList<String> lista = new ArrayList<String>(); 
        for (GrauProficiencia grau : this.getListaGrausProficiencia()) {
     ...
     * @return objecto área de atividade da competência técnica
     */
    public RegistoGrausProficiencia getGrausProficiencia() {
        return this.grausProficiencia;
    }
    ...
    private void setGrausProf(List<GrauProficiencia> grausProf) throws SQLException {
        for (GrauProficiencia gp : grausProf) {
            this.grausProficiencia.registaGrauProficiencia(gp);
        }
    }
