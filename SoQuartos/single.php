...
<body>
  ...
  <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
        ...
        <ul class="navbar-nav">
          ...
          <?php
                   if (isset($_SESSION["session"])){
                       echo '<li class="nav-item" id="Adicionarcasa">
            <a class="nav-link" href="Admin/dark/adicionarcasa.php">Adicionar Casa</a>
          </li>';
    ...
    <?php
            ...
            echo ' <p id="showuser">'.$_SESSION["login"].'</p>
    ...
    ?>
        ...
        <div class="col-md-12">
          <div class="row section-t3">
            <div class="col-sm-12">
              <div class="title-box-d">
                <h3 class="title-d">Proprietário</h3>
              </div>
            </div>
          </div>
