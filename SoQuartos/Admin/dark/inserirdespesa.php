    ...
    <div id="main-wrapper">
      ...
      <div class="card">
        <div class="card-body">
            ...
            <label for="fname">Insira uma foto da Fatura</label><br><br>
      ...
      <div class="card">
        <div class="card-body">
            <center><h2 style="padding-right: 200px;">Tipo de Fatura</h2></center>
            <div>
            <br><label for="fname">Insira o Tipo de Despesa</label><br>
    <?php 

     include 'PHP/tipo_despesa.php';

     ?>
        <br>
        <label style="padding-top: 10px;">Insira o mês da Fatura</label>
        <br>    
        <?php 
     ...
     ?>
      ...
      <div class="card">
        <div class="card-body">
            <center><h2 style="padding-right: 200px;padding-bottom: 30px;">Detalhes</h2></center>

                <label for="lname">Insira o Valor</label><br>
                <input style="width:20%" type="number" id="price" name="price" placeholder="" required>€
                <br>    <br>    
                <label for="distrito">Insira a data limite de Pagamento</label><br>
...
<center><button onclick="registardespesa()" class="btn btn-a">Registar Despesa</button>    </center>
</div>


<p id="registodespesa"></p>
</div>
                <!-- ============================================================== -->
                <!-- End PAge Content -->
                <!-- ============================================================== -->
