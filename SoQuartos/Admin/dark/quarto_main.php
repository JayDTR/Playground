        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><h3 class="text-themecolor"><?php
                    ...
                    <ol class="breadcrumb">
                        <?php  
                              ...
                              if ($op == 0) {
                                ...
                                echo '<li class="breadcrumb-item"><a href="index_inquilino.php">HOME</a></li>';
                              }
                ...
                <div class="row">
                    <div class=" card-group" style="margin-bottom: 10px;">
                        <div class="card" style="width: 650px;height: 400px;">
                            <div class="card-body">
                                <div class="row">   
                                <?php include 'php/quarto_main1.php' ?>
                                </div>    
                            </div>
                        </div>
                        <div>&nbsp;</div>
                        <div class="card" style="width: 650px;height: 400px;">
                            <div class="card-body">
                                <?php include 'php/quarto_main2.php' ?>
                    ...
                    <div class="col-lg-3 col-xlg-2 col-md-4" style="display: block;">
                        <div class="stickyside">
                            <div class="list-group" id="top-menu" >
                             <?php include 'php/quarto_sidebar.php'; ?>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class=" card-group">
                         <div class="card" style="width: 650px;height: 400px;">
                            <div class="card-body">
                                <?php include 'php/quarto_main3.php' ?>
                            </div>
                        </div>
                         <div>&nbsp;</div>
                        <div class="card" style="width: 650px;height: 400px;">
                            <div class="card-body">
                            <?php
                                 if ($_SESSION["op_tipo_utilizador"] == 1) {
                                                    include 'chat.php';
                                                  }else{
