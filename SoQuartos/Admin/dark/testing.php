...
<div class="card-group">
  <div class="card">
    <div class="card-body">
        ...
        <label for="fname">Insira uma foto da casa</label><br><br>
  ...
  <div class="card">
    <div class="card-body">
        ...
        <br><label for="fname">Insira o Distrito</label><br>


    <?php 
    include '../../PHP/distrito_casa.php';
    ?>
    <br>
    <label for="lname">Insira a morada</label><br>
    <input style="width:60%" type="text" id="rmorada" name="morada" placeholder="Insira a morada" required><br>
  ...
  <div class="card">
    <div class="card-body">
        <center><h2 style="padding-right: 200px;">Mais Detalhes</h2></center>
           <br> <label for="distrito">Insira o Tipo de casa (Ex: T1 = 1 Quarto)</label><br>

    <?php 

 include '../../PHP/tipo_casa.php';
  

 ?>
    <br>

      <label for="Internet">Tem internet?</label><br>

    <select class='form-control form-control-lg form-control-a' style="width:60%" id="rinternet" name="rinternet" required>
...
<center><button onclick="registarcasa()" class="btn btn-a">Registar</button>    </center>
</div>
  ...
  <!-- <div id="div">
    ...
    <label for="fname">Insira uma foto da casa</label><br><br>
    <input type="file" id="upload">
    <br><br><label for="fname">Insira o Distrito</label><br><br>
 ...
 ?>
    ...
    <label for="distrito">Insira o Tipo de casa (Ex: T1 = 1 Quarto)</label><br>
 ...
 ?>
  ...
  <br><br>
     <button  type="submit" onclick="registarcasa()" class="btn btn-a">Registar</button>
