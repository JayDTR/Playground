...
<body class="fix-header card-no-border">
  ...
  <div class="card">
    <div class="card-body">
        ...
        <?php 
                     $op=2;
                include "PHP/editarfoto.php";

             ?>
               <br> <br><input type="file" id="upload">
        </div>
    </div>
  </div>
  <div class="card">
    <div class="card-body">
        <center><h2 style="padding-right: 200px;">Descrição</h2></center>
        <div style="padding-bottom: 50px;">
        <?php 
                     $op=1;
                include "PHP/editarquarto.php";
...
<?php 
$id = $_GET["id"]; 
echo "<p style='display: none' id='idquarto' name='idcasa'>".$id."</p>";
?>
...
<center><button onclick="editarQuarto()" class="btn btn-a">Registar</button>    </center>
</div>
