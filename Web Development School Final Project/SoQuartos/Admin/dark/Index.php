...
if (!$conn) {
     ...
     $sql = "SELECT * from despesasgerais where idestado!=1 and  NOW() > datalimite";
        ...
        $result = $conn->query($sql);
          ...
          while($row = $result->fetch_assoc()) {
            ...
            $sql1 = 'UPDATE despesasgerais SET idestado = 3 WHERE id='.$row['id'].';';
    ...
    <div id="main-wrapper">
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                <!-- User profile -->
                <div style="margin-top: 10px;" class="user-profile">
                    <!-- User profile image -->
                    <?php
                ...
                <div class="row">
                    <div class=" col-xl-10">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <?php include 'php/selectcartacasa.php'; ?>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-xlg-2 col-md-4" style="display: none;">
                        <div class="stickyside">
                            <div class="list-group" id="top-menu" >
                                <a href="#1" class="list-group-item active">Quarto 1</a>
                                <a href="#2" class="list-group-item">Quarto 2</a>
                                <a href="#3" class="list-group-item">Quarto 3</a>
                            </div>
                        </div>
                    </div>
                </div>
