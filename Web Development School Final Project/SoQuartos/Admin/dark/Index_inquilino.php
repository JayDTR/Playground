        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Os seus quartos</h3>
                </div>
                ...
                <div class="row">
                    <div class=" col-xl-10">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <?php include 'selectcasa.php'  ?>
                                    <?php echo  '<script>window.location.href = "gestaoquartos.php?id='.$idcasa.'";</script>';  ?>
                                </div>
                            </div>
                        </div>
                    </div>
