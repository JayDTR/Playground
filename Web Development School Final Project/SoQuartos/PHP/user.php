	...
	if($op==1){ 
     ...
     $msg='';
		...
		if ($psw!=$psw2) {
			...
			$sql = "INSERT INTO utilizador(nome,telefone,email,datanascimento,nif,idtipoutilizador,password,foto,nrcc) VALUES('$username',$telefone,'$email','$nasc','$NIF', 2,'$psw','upload/user/default.jpg','$nBI'); ";
    	...
    	die("Connection failed: " . $conn->connect_error);
			...
			$sql = "SELECT id,email,nome,password,foto FROM utilizador;";
     		$result = $conn->query($sql);
